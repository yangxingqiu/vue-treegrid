  ...
  components: {
    NodeContent: {
      ...
      render: function render(h) {
        ...
        return this.col.renderContent ? this.col.renderContent(h, { node: node, data: data, store: store }) : h(
          'td',
          null,
          [this.node.data[this.col.name]]
        );
      }
    }
  },
...
var _treeStore = __webpack_require__(10);
...
exports.default = {
  ...
  components: {
    ElTreeNode: __webpack_require__(16)
  },
  ...
  methods: {
    ...
    getCheckedTree: function getCheckedTree() {
...
var _zhCN = __webpack_require__(8);
...
var Node = function () {
  ...
  Node.prototype.updateData = function updateData(data) {
    if (!Array.isArray(data)) {
      (0, _util.markNodeData)(this, data);
    }
  ...
  Node.prototype.moveNode = function moveNode(index) {
    var parent = this.parent;
    var thisIndex = parent.childNodes.indexOf(this);
    var toIndex = index + thisIndex;
  ...
  Node.prototype.removeChild = function removeChild(child, notDestroy) {
  ...
  Node.prototype.expand = function expand(callback, expandParent) {
    ...
    var done = function done() {
      ...
      _this.expanded = true;
      _this._setFatheExpanded(_this, true);
  ...
  Node.prototype._setFatheExpanded = function _setFatheExpanded(node, b) {
    if (b) {
  ...
  Node.prototype.__LevelDepth = function __LevelDepth(level) {
    this.level = level;
    this.childNodes.forEach(function (node) {
      return node.__LevelDepth(level + 1);
    });
  };

  Node.prototype._getData = function _getData() {};
...
var TreeStore = function () {
  ...
  TreeStore.prototype.getNode = function getNode(data) {
    if (data instanceof _node2.default) {
      return data;
    }
  ...
  TreeStore.prototype.move = function move(data, parent) {
    console.log('move arg: ', data, parent);
    var node = this.getNode(data);
    var pnode = this.getNode(parent);
  ...
  TreeStore.prototype.getCheckedTree = function getCheckedTree() {
    var checkedTree = [];
    var traverse = function traverse(node, tree) {
      var childNodes = node.root ? node.root.childNodes : node.childNodes;
      childNodes.forEach(function (child) {
        if (child.checked) {
          tree.push(child.data);
        } else if (child.indeterminate) {
          var childTree = [];
          traverse(child, childTree);
          tree.push(Object.assign({}, child.data, { children: childTree }));
        }
      });
    };

    traverse(this, checkedTree);
    return checkedTree;
  };
  ...
  TreeStore.prototype.getAllNodesByDepthFirst = function getAllNodesByDepthFirst() {
    var visite = [];
    var allNodes = [];
    var cnode = null;
    for (var i = this.root.childNodes.length - 1; i > -1; i--) {
      visite.push(this.root.childNodes[i]);
    }
    ...
    while (visite.length > 0) {
      ...
      if (cnode.childNodes.length > 0) {
        for (var _i = cnode.childNodes.length - 1; _i > -1; _i--) {
          visite.push(cnode.childNodes[_i]);
        }
      }
    }
  ...
  TreeStore.prototype.getData = function getData() {};
...
// module
exports.push([module.i, "\n.el-tree-node__content.is-checked[data-v-4bb4d3d0]{\n  background: rgb(228, 233, 241);\n}\nspan[data-v-4bb4d3d0]{\n  margin: 0 5px\n}\n.el-tree-node__expand-icon[data-v-4bb4d3d0]{\n  margin-left: 10px\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('tr', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.node.visible && _vm.node.fatheExpanded),
      expression: "node.visible&&node.fatheExpanded"
    }],
  ...
  }) : _vm._e(), _vm._v(" "), _c('span', [_vm._v(_vm._s(_vm.node.data[_vm.columns[0].name]))])], 1), _vm._v(" "), _vm._l((_vm.columns.slice(1)), function(col) {
    return [_c('node-content', {
      attrs: {
        "node": _vm.node,
        "col": col
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('thead', [_c('tr', _vm._l((_vm.columns), function(col) {
    return _c('th', {
      style: ({
        width: col.width + 'px',
    ...
    ref: "fuck"
  }, _vm._l((_vm.store.getAllNodesByDepthFirst()), function(child) {
    return _c('el-tree-node', {
      key: _vm.getNodeKey(child),
      ref: 'node' + _vm.getNodeKey(child),
      refInFor: true,
      attrs: {
        "node": child,
        "props": _vm.props,
...
var update = __webpack_require__(21)("4b0f20ac", content, true);
